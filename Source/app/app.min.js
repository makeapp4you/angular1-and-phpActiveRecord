...
b.upload=function(a){b.progress=0;b.fileName="";c.upload({url:"api/upload",file:a}).progress(function(a){b.progress=parseInt(100*a.loaded/a.total)}).success(function(a){var c=a&&a.errors;c&&c.length?(b.fileError=!0,b.fileTemp=!1):(b.fileError=!1,b.fileName=a&&a.file&&a.file.name,b.fileTemp=a&&a.file&&a.file.temp)})};a.setTitle("T\u1ea1o b\u00e0i vi\u1ebft");a.setPath("posts/create")}]);
...
{title:a.title,intro:a.intro,content:k,category_id:f,image:b.input&&b.input.image},function(a){b.errors=a&&a.errors;b.messages=a&&a.messages;b.messages&&b.messages.length&&(e.setFlashMessages(b.messages),d.path("admin/post"))})};b.upload=function(a){b.progress=0;b.fileName="";f.upload({url:"api/upload",file:a}).progress(function(a){b.progress=parseInt(100*a.loaded/a.total)}).success(function(a){var c=a&&a.errors;c&&c.length?(b.fileError=!0,b.fileTemp=!1):(b.input.image=a&&a.file&&a.file.hash,b.fileError=
...
newsApp.factory("Category",["$rootScope","$http",function(b,d){this.all=function(a,b){d.get("api/category?page="+b).then(function(b){a(b.data)})};this.create=function(a,b){d.post("api/category/create",a).then(function(a){b(a.data)})};this.get=function(a,b){d.get("api/category/"+a).then(function(a){b(a.data)})};this.update=function(a,b,c){d.put("api/category/"+a,b).then(function(a){c(a.data)})};this["delete"]=function(a,b){d["delete"]("api/category/"+a).then(function(a){b(a.data)})};return this}]);
...
newsApp.factory("Home",["$rootScope","$http",function(b,d){this.getPosts=function(a,b){d.get("api/home?page="+b).then(function(b){a(b.data)})};this.getCategories=function(a){d.get("api/home/category/get").then(function(b){a(b.data)})};this.getPostsByCategory=function(a,b,c){d.get("api/home/category/"+a+"?page="+c).then(function(a){b(a.data)})};this.showPost=function(a,b){d.get("api/home/"+a).then(function(a){b(a.data)})};return this}]);
newsApp.factory("Post",["$rootScope","$http",function(b,d){this.all=function(a,b){d.get("api/post?page="+b).then(function(b){a(b.data)})};this.create=function(a,b){d.post("api/post/create",a).then(function(a){b(a.data)})};this.creator=function(a){d.get("api/post/creator").then(function(b){a(b.data)})};this.get=function(a,b){d.get("api/post/"+a).then(function(a){b(a.data)})};this.update=function(a,b,c){d.put("api/post/"+a,b).then(function(a){c(a.data)})};this["delete"]=function(a,b){d["delete"]("api/post/"+
a).then(function(a){b(a.data)})};return this}]);
newsApp.factory("User",["$rootScope","$http",function(b,d){this.login=function(a,b){d.post("api/login",a).then(function(a){b(a.data)})};this.logout=function(a){d.get("api/logout").then(function(b){a(b.data)})};this.isLogin=function(a){d.get("api/isLogin").then(function(b){a(b.data)})};this.all=function(a,b){d.get("api/user?page="+b).then(function(b){a(b.data)})};this.create=function(a,b){d.post("api/user/create",a).then(function(a){b(a.data)})};this.get=function(a,b){d.get("api/user/"+a).then(function(a){b(a.data)})};
this.update=function(a,b,c){d.put("api/user/"+a,b).then(function(a){c(a.data)})};this["delete"]=function(a,b){d["delete"]("api/user/"+a).then(function(a){b(a.data)})};return this}]);
